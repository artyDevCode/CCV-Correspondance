    ...
    public class AccessController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,AccessGroup,UserId,UserName")] Access access)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    return RedirectToAction("Alert", "Correspondance", new { alertMessage = "User access for " + access.UserName + " as " + access.AccessGroup + " is already defined.", SPHostUrl = SharePointContext.GetSPHostUrl(HttpContext.Request).AbsoluteUri });
                }
        ...
        public ActionResult Delete(int? id)
        {
            if (id == null)
            {
                return RedirectToAction("Alert", "Correspondance", new { alertMessage = "Access control not found, contact administrator.", SPHostUrl = SharePointContext.GetSPHostUrl(HttpContext.Request).AbsoluteUri });
            }
